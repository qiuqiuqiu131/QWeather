...
![](assets/WeatherScreenDown.jpg)
#### 1.3、 **底部栏**
底部栏是一个**页面索引栏**，用于显示当前显示的城市的索引。
![](assets/WeatherScreenButtom.jpg)
...
#### 2.1、 实况天气页面
![](assets/TimelyWeatherScreen.jpg)
城市的实时天气数据，同时显示全国城市天气地图和实时新闻数据
#### 2.2、每日天气页面
![](assets/DailyScreen.jpg)
##### 2.2.1、逐小时天气预测图表
![](assets/HourlyWeatherChart.jpg)
...
##### 2.2.2、生活指数列表
![](assets/LifeIndices.jpg)
呈现一个生活指数列表，包含生活指数以及建议。
点击生活指数Item可以转跳到对应的Page。
##### 2.2.3、星座运势卡片
![](assets/ConstellationCard.jpg)
显示当天的星座运势信息，可以切换星座。

#### 2.3、多日天气页面
![](assets/MoreDailyWeatherScreen.jpg)
显示更多未来多日的天气信息

#### 2.4、空气质量页面
![](assets/AirScreen.jpg)
显示当前城市的实时空气质量信息。
下方图表显示未来24小时的空气质量趋势。

#### 2.5、生活指数页面
![](assets/LifeIndicesScreen1.jpg)
包含16种生活指数的页面。
...
![](assets/SolarTermScreen.jpg)
![](assets/SolarTermScreenDown.jpg)
应用为不同的节气设置了不同的主题
另外，还能查看当天节气的详细介绍。
![](assets/SolarTermDetail.jpg)